...
<template>
    <nav class="rounded-md dark:bg-light text-gray-800 dark:text-gray-100 m-auto w-full md:w-[80%] lg:max-w-[1640px]">
        <div class="flex py-3 px-6 justify-between ">
            <a class="flex-start" href="/">
                <!-- <svg class="h-9 w-10" width="37" height="40" viewBox="0 0 37 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <img class="flex-0 h-10 w-10" width="40" height="40" src="images/logo-dark.png" alt="Logo">
                <!-- <img class="none flex-0 h-10 w-10" width="40" height="40" src="images/logo-light.png" alt="Logo"> -->
            </a>
            <div class="flex justify-start">
                <ul class="hidden md:flex md:justify-between self-center">
